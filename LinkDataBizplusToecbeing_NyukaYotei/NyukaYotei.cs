...
{
    public class NyukaYotei : AbstractBatch
    {
        #region 定数定義
        ...
        public NyukaYotei(string[] args)
            : base(logger, resultLogger)
        {
            Args = args;
            ConstResultKeyWord = BatchConst.NYUKA_YOTEI_INFO_RESULT_LOG_KEYWORD;
            ConstBatchNm = BatchConst.NYUKA_YOTEI_INFO_BATCH_NAME;
            ConstStored = SqlConst.NYUKA_YOTEI_INFO_BATCH_STORED;
            ConstCsvFile = BatchConst.NYUKA_YOTEI_INFO_CSV_FILE;
            ConstCsvBackupFile = BatchConst.NYUKA_YOTEI_INFO_CSV_BACKUP_FILE;
            ConstCsvUploadFile = BatchConst.NYUKA_YOTEI_INFO_CSV_UPLOAD_FILE;
